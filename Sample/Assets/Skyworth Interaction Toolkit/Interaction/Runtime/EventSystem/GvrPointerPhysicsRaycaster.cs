...
public class GvrPointerPhysicsRaycaster : GvrBasePointerRaycaster
{
      ...
      PointerEventData eventData, List<RaycastResult> resultAppendList)
    {
        ...
        for (int i = 0; i < numHits; ++i)
        {
            ...
            var sorting = hits[i].collider.gameObject.GetComponent<SortingGroup>();
            RaycastResult result = new RaycastResult
            {
                ...
                sortingLayer = sorting != null ? sorting.sortingLayerID : 0,
                sortingOrder = sorting != null ? sorting.sortingOrder : 0
            };

            resultAppendList.Add(result);
        }
        //System.Text.StringBuilder sb = new System.Text.StringBuilder();
        //foreach (var item in resultAppendList)
        //{
