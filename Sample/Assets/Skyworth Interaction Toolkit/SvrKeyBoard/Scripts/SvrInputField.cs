/*
 * @Author: xieminghui
 * @Date: 2020-12-30 17:18:03
 * @Description: Description
 * @LastEditors: xieminghui
 * @LastEditTime: 2021-01-05 11:51:01
...
namespace Svr.Keyboard
{
    ...
    [AddComponentMenu("UI/Svr Input Field", 34)]
    public class SvrInputField
        : Selectable,
        ...
        
    {
        ...
        [SerializeField]
        private OnSelectEvent m_OnSelectEvent = new OnSelectEvent();
        ...
        private bool m_OnSelected = false;
        ...
        public string text
        {
            ...
            set
            {
                ...
                if (SvrInputMethod.Instacne)
                    SvrInputMethod.Instacne.ShowKeyboard(transform,m_Text);
        ...
        {
            base.Start();
            //if (ComplexBoardAction.Instance)
            //    ComplexBoardAction.Instance.OnAddEvent.AddListener(OnAdd_Event);
            //if (ComplexBoardAction.Instance)
            //    ComplexBoardAction.Instance.AddListeners(KeyCoard_Event, KeyDelete_Event, Sumbit_Event, SwitchKeyboard_Event, CloseKeyboard_Event);
        }

        private void OnAdd_Event()
        {
            //Debug.Log("OnAdd_Event:"+ EventSystem.current.currentSelectedGameObject);
        ...
        protected override void OnDestroy()
        {
            ...
            //if (ComplexBoardAction.Instance)
            //{
            //    ComplexBoardAction.Instance.OnAddEvent.RemoveListener(OnAdd_Event);
            //        ComplexBoardAction.Instance.RemoveListeners();
            //}
        ...
        protected override void OnEnable()
        {
            ...
            if (m_TextComponent != null)
            {
                ...
                //ComplexBoardAction.OnAddEvent.AddListener(OnAdd_Event);
        }
        ...
        protected override void OnDisable()
        {
            ...
            //Debug.Log("UnRegisterCanvasElementForRebuild");
            ...
            //ComplexBoardAction.OnAddEvent.RemoveListener(OnAdd_Event);
            //if (ComplexBoardAction.Instance)
            //{
            //    ComplexBoardAction.Instance.RemoveListeners();
            //}
        ...
        protected virtual void LateUpdate()
        {
            ...
            //string val = SvrInputMethod.Instacne.text;

            //if (m_Text != val)
            //{
            //    if (m_ReadOnly)
            //    {
            //        SvrInputMethod.Instacne.text = m_Text;
            //    }
            //    else
            //    {
            //        m_Text = "";
        ...
        public override void OnPointerDown(PointerEventData eventData)
        {
            ...
            Vector3 localpos = eventData.pointerCurrentRaycast.gameObject.transform.worldToLocalMatrix.MultiplyPoint(eventData.pointerCurrentRaycast.worldPosition);
            //Debug.Log("localpos:"+localpos);
            TextGenerator textGenerator = m_TextComponent.cachedTextGenerator;
            //Debug.Log(textGenerator.characters[textGenerator.characters.Count-1].cursorPos);
            //myCaretTest.transform.localPosition = localpos;
            float Mintwoposdistance = Vector2.Distance(textGenerator.characters[0].cursorPos, localpos);
            int findminIndex = 0;
            //for (int i = 0; i < textGenerator.characters.Count; i++)
            //{
            //    float temptwoposdistance = Vector2.Distance(textGenerator.characters[i].cursorPos, localpos);
            //    if (temptwoposdistance <= Mintwoposdistance)
            //    {
            //        findminIndex = i;
            //        Mintwoposdistance = temptwoposdistance;
            //    }
            //    else
            //        break;
            //}
            findminIndex = m_DrawStart+GetCharacterIndexFromPosition(new Vector2(localpos.x, localpos.y));
            caretPosition = findminIndex;
            if(SvrInputMethod.Instacne)
                SvrInputMethod.Instacne.setSelection(caretPosition);
            UpdateLabel();
            eventData.Use();
        }
...
//                return;
        ...
        private void MarkGeometryAsDirty()
        {
            ...
            if (!Application.isPlaying || UnityEditor.PrefabUtility.GetPrefabObject(gameObject) != null)
                return;
#endif
            //Debug.Log("RegisterCanvasElementForGraphicRebuild");
        ...
        public void ActivateInputField()
        {
            ...
            //        ComplexBoardAction.Instance.ShowBoard(KeyboardType.Digit);
            //        break;
            //    case ContentType.Japan:
            //        ComplexBoardAction.Instance.ShowBoard(KeyboardType.Japan);
            //        break;
            //    default:
            //        ComplexBoardAction.Instance.ShowBoard(KeyboardType.Letter);
            //        break;
            //}
            if (isFocused)
            {
                if (SvrInputMethod.Instacne != null)
                {
                    SvrInputMethod.Instacne.OnTextChange = Instacne_OnTextChange;
                    SvrInputMethod.Instacne.OnKeyboardClose = SvrInputMethod_OnKeyboardClose;
                    SvrInputMethod.Instacne.ShowKeyboard(transform,m_Text);
                }
            }
        ...
        private void SvrInputMethod_OnKeyboardClose()
        {
            if (EventSystem.current.currentSelectedGameObject == gameObject)
                EventSystem.current.SetSelectedGameObject(null);
            DeactivateInputField();
        }
        private void Instacne_OnTextChange(string obj,int starselection,int endselection)
        {
            m_Text = obj;
            m_CaretPosition = starselection;
            caretSelectPositionInternal = starselection;

            SendOnValueChanged();
            UpdateLabel();
        }

        private void KeyCoard_Event(char txt)
        {
        ...
        private void KeyDelete_Event()
        {
            Backspace();
        }
        private void Sumbit_Event()
        {
            DeactivateInputField();
        }
        //private void SwitchKeyboard_Event(KeyboardType type)
        //{
        //    //Debug.Log("SwitchKeyboard_Event:" + type);
        //}
        //private void CloseKeyboard_Event()
        //{
        //    //Debug.Log("CloseKeyboard_Event");
        //    DeactivateInputField();
        //    //if (ComplexBoardAction.Instance)
        //    //    ComplexBoardAction.Instance.RemoveListeners();
        //}
        ...
        {
            Debug.Log("ActivateInputFieldInternal");
        ...
        public void DeactivateInputField()
        {
            ...
            if (m_TextComponent != null && IsInteractable())
            {
                ...
                //    SvrInputMethod.Instacne.OnTextChange = null;
                //}
        ...
        //void IPointerHoverHandler.OnPointerHover(PointerEventData eventData)
        //{
        //    //Debug.LogFormat("[{0}],({1})",eventData.pointerCurrentRaycast.gameObject, eventData.pointerCurrentRaycast.worldPosition);
